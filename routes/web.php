...
Route::group(["prefix" => "account"], function () {
    Route::post('/login', [AccountController::class, 'check_login'])->name('account.login');
    Route::get('/logout', [AccountController::class, 'logout'])->name('account.logout');
    Route::get('/verify-account/{email}', [AccountController::class, 'verify'])->name('account.verify');
    Route::post('/register', [AccountController::class, 'check_register'])->name('account.register');
    Route::post('/forgot-password', [AccountController::class, 'forgot_password'])->name('account.forgotPass');
    Route::get('/reset-password/{token}', [AccountController::class, 'show_reset_password'])->name('account.resetPass');
    Route::post('/reset-password/{token}', [AccountController::class, 'reset_password']);

    Route::group(["middleware" => "customer"], function () {
        Route::get('/profile', [AccountController::class, 'profile'])->name('account.profile');
        Route::post('/profile', [AccountController::class, 'check_profile']);
        Route::post('/change-password', [AccountController::class, 'change_password'])->name('account.changePassword');
...
Route::group(["prefix" => "cart", "middleware" => "customer"], function () {
    ...
    Route::get('/update/plus/{product}/{product_detail}', [CartController::class, 'update_plus'])->name('cart.updatePlus');
    Route::get('/update/munis/{product}/{product_detail}', [CartController::class, 'update_munis'])->name('cart.updateMinus');
    Route::get('/delete/{product}/{product_detail}', [CartController::class, 'delete'])->name('cart.delete');
...
Route::group(["prefix" => "check-out", "middleware" => "customer"], function () {
    ...
    Route::get('/return_vnpay/{bill}', [OrderController::class, 'return_vnpay'])->name("checkout.returnVnpay");
    Route::get('/return_momo/{bill}', [OrderController::class, 'return_momo'])->name("checkout.returnMomo");
    Route::post('/', [OrderController::class, 'check_out']);
    Route::get('/{token}', [OrderController::class, 'verify'])->name('checkout.verify');
});
...
Route::group(["prefix" => "admin", "middleware" => ["auth", "admin"]], function () {
    ...
    Route::get("product-createdetail/{product_id}", [ProductController::class, "createDetail"])->name("product.createDetail");
    Route::post("product-updatedetail", [ProductController::class, "updateDetail"])->name("product.updateDetail");
    Route::get("product-deletedetail/{product_detail}", [ProductController::class, "deleteDetail"])->name("product.deleteDetail");
