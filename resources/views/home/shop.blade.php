                    ...
                    <div
                        ...
                        <div class="shop-results d-flex align-items-center"><span>Hiển thị</span>
                            <div class="shop-select">
                                <form class="product-update-show" action="{{route('home.shop')}}" method="get">
                                    @if($sort != "default")
                        ...
                        <div class="shop-results d-flex align-items-center"><span>Sắp xếp theo</span>
                            <div class="shop-select">
                                <form class="product-update-sort" action="{{route('home.shop')}}" method="get">
                                    @if($perPage != "9")
                        ...
                        <div class="sidebar-block price">
                            ...
                            <div id="price" class="collapse show">
                                <div class="price-inner">
                                    ...
                                    <form id="fillter-price-form" action="{{route('home.shop')}}" method="get">
                                        @if($perPage != "9")
                                        <input type="hidden" name="show" value="{{ $perPage }}">
                                        @endif
                                        @if($sort != "default")
