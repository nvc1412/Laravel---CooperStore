    ...
    <div class="slider-wrapper my-40 my-sm-25 float-left w-100">
        <div class="container">
            ...
            <div class="slider slider-for owl-carousel">
                @foreach($top_bans as $ban)
                <div>
                    <a href="{{$ban->link}}">
                        <img src="img/banner/{{$ban->image}}" alt="" height="800" width="1600" />
                    </a>
                </div>
                @endforeach
            </div>
                            ...
                            <div class="tab-pane active float-left w-100" id="ttfeatured-main" role="tabpanel"
                                ...
                                <section id="ttfeatured" class="ttfeatured-products">
                                    <div class="ttfeatured-content products grid owl-carousel" id="owl1">
                                        ...
                                        @foreach($news_pros_quan as $np_quan)
                                        <div class="product-layouts">
                                            <div class="product-thumb">
                                                <div class="image zoom">
                                                    <a href="{{route("home.showProductDetail", $np_quan->id)}}">
                                                        <img src="img/products/{{$np_quan->image}}" alt="02"
                                                            height="501" width="385" />

                                                        <img src="img/products/{{$np_quan->image}}" alt="03"
                                                ...
                                                <div class="thumb-description">
                                                    <div class="caption">
                                                        <h4 class="product-title text-capitalize"><a
                                                                href="{{route("home.showProductDetail", $np_quan->id)}}">{{$np_quan->name}}</a>
                                                        </h4>
                                                    </div>
                                                    <div class="rating">
                                                        <div class="product-ratings d-inline-block align-middle">
                                                            @for($x = 1; $x <= 5 ; $x++) @if($x
                                                                <=average_rate($np_quan->ratings))
                                                    ...
                                                    <div class="price">
                                                        @if($np_quan->discount > 0)
                                                        <div class="regular-price">
                                                            {{number_format($np_quan->discount)}}đ
                                                        </div>
                                                        <div class="old-price">{{number_format($np_quan->price)}}đ</div>
                                                        @else
                                                        <div class="regular-price">
                                                            {{number_format($np_quan->price)}}đ
                                                        </div>
                                                        @endif
                                                    </div>
                                                        ...
                                                        <div class="button-group text-center">
                                                            <a href='{{route("home.showProductDetail", $np_quan->id)}}'
                                                                class="btn btn-primary btn-cart"><i
                                                                    ...
                                                                    to cart</span></a>
                                                            @if(auth()->check())
                                                            <a href='{{route("home.favorite", $np_quan->id)}}'
                                                                class="btn btn-primary btn-wishlist {{($np_quan->favorited == true) ? 'wishlist-active' : ''}}"><i
                            ...
                            <div class="tab-pane float-left w-100" id="ttnew-main" role="tabpanel"
                                ...
                                <section id="ttnew" class="ttnew-products">
                                    <div class="ttnew-content products grid owl-carousel" id="owl2">
                                        ...
                                        @foreach($news_pros_ao as $np_ao)
                                        <div class="product-layouts">
                                            <div class="product-thumb">
                                                <div class="image zoom">
                                                    <a href="{{route("home.showProductDetail", $np_ao->id)}}">
                                                        <img src="img/products/{{$np_ao->image}}" alt="02" height="501"
                                                            width="385" />

                                                        <img src="img/products/{{$np_ao->image}}" alt="03"
                                                            class="second_image img-responsive" height="501"
                                                            width="385" /></a>
                                                </div>
                                                <div class="thumb-description">
                                                    <div class="caption">
                                                        <h4 class="product-title text-capitalize"><a
                                                                href='{{route("home.showProductDetail", $np_ao->id)}}'>{{$np_ao->name}}</a>
                                                        </h4>
                                                    </div>
                                                    <div class="rating">
                                                        <div class="product-ratings d-inline-block align-middle">
                                                            @for($x = 1; $x <= 5 ; $x++) @if($x <=average_rate($np_ao->
                                                                ratings))
                                                                <span class="fa fa-stack"><i
                                                                        class="material-icons">star</i></span>
                                                                @else
                                                    ...
                                                    <div class="price">
                                                        @if($np_ao->discount > 0)
                                                        <div class="regular-price">
                                                            {{number_format($np_ao->discount)}}đ
                                                        </div>
                                                        <div class="old-price">{{number_format($np_ao->price)}}đ</div>
                                                        @else
                                                        <div class="regular-price">
                                                            {{number_format($np_ao->price)}}đ
                                                        </div>
                                                        @endif
                                                    </div>
                                                    <div class="button-wrapper">
                                                        <div class="button-group text-center">
                                                            <a href='{{route("home.showProductDetail", $np_ao->id)}}'
                                                                class="btn btn-primary btn-cart"><i
                                                                    ...
                                                                    to cart</span></a>
                                                            @if(auth()->check())
                                                            <a href='{{route("home.favorite", $np_ao->id)}}'
                                                                class="btn btn-primary btn-wishlist {{($np_ao->favorited == true) ? 'wishlist-active' : ''}}"><i
                                                                    class="material-icons">favorite</i><span>wishlist</span></a>
                                                            @endif
                                                            <a href="{{route("home.showProductDetail", $np_ao->id)}}"
                                                                class="btn btn-primary btn-quickview"><i
                            ...
                            <div class="tab-pane float-left w-100" id="ttbestseller-main" role="tabpanel"
                                ...
                                <section id="ttbestseller" class="ttbestseller-products">
                                    <div class="ttbestseller-content products grid owl-carousel" id="owl3">
                                        ...
                                        @foreach($news_pros_phukien as $np_phukien)
                                        <div class="product-layouts">
                                            <div class="product-thumb">
                                                <div class="image zoom">
                                                    <a href="{{route("home.showProductDetail", $np_phukien->id)}}">
                                                        <img src="img/products/{{$np_phukien->image}}" alt="02"
                                                            height="501" width="385" />

                                                        <img src="img/products/{{$np_phukien->image}}" alt="03"
                                                            class="second_image img-responsive" height="501"
                                                            width="385" /></a>
                                                </div>
                                                <div class="thumb-description">
                                                    <div class="caption">
                                                        <h4 class="product-title text-capitalize"><a
                                                                href="{{route("home.showProductDetail", $np_phukien->id)}}">{{$np_phukien->name}}</a>
                                                        </h4>
                                                    </div>
                                                    <div class="rating">
                                                        <div class="product-ratings d-inline-block align-middle">
                                                            @for($x = 1; $x <= 5 ; $x++) @if($x
                                                                <=average_rate($np_phukien->
                                                                ratings))
                                                                <span class="fa fa-stack"><i
                                                                        class="material-icons">star</i></span>
                                                                @else
                                                    ...
                                                    <div class="price">
                                                        @if($np_phukien->discount > 0)
                                                        <div class="regular-price">
                                                            {{number_format($np_phukien->discount)}}đ
                                                        </div>
                                                        <div class="old-price">{{number_format($np_phukien->price)}}đ
                                                        </div>
                                                        @else
                                                        <div class="regular-price">
                                                            {{number_format($np_phukien->price)}}đ
                                                        </div>
                                                        @endif
                                                    </div>
                                                    <div class="button-wrapper">
                                                        <div class="button-group text-center">
                                                            <a href='{{route("home.showProductDetail", $np_phukien->id)}}'
                                                                class="btn btn-primary btn-cart"><i
                                                                    ...
                                                                    to cart</span></a>
                                                            @if(auth()->check())
                                                            <a href='{{route("home.favorite", $np_phukien->id)}}'
                                                                class="btn btn-primary btn-wishlist {{($np_phukien->favorited == true) ? 'wishlist-active' : ''}}"><i
                                                                    class="material-icons">favorite</i><span>wishlist</span></a>
                                                            @endif
                                                            <a href="{{route("home.showProductDetail", $np_phukien->id)}}"
                                                                class="btn btn-primary btn-quickview"><i
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="ttspecial-content products grid owl-carousel">
                            ...
                            @foreach($trends_pros as $trend)
                            <div class="product-layouts">
                                <div class="product-thumb">
                                    <div class="image zoom">
                                        <a href="{{route("home.showProductDetail", $trend->id)}}">
                                            <img src="img/products/{{$trend->image}}" alt="02" height="501"
                                                width="385" />

                                            <img src="img/products/{{$trend->image}}" alt="03"
                                                class="second_image img-responsive" height="501" width="385" /></a>
                                    </div>
                                    <div class="thumb-description">
                                        <div class="caption">
                                            <h4 class="product-title text-capitalize"><a
                                                    href="{{route("home.showProductDetail", $trend->id)}}">{{$trend->name}}</a>
                                            </h4>
                                        </div>
                                        <div class="rating">
                                            <div class="product-ratings d-inline-block align-middle">
                                                @for($x = 1; $x <= 5 ; $x++) @if($x <=average_rate($trend->
                                                    ratings))
                                        ...
                                        <div class="price">
                                            @if($trend->discount > 0)
                                            <div class="regular-price">
                                                {{number_format($trend->discount)}}đ
                                            </div>
                                            <div class="old-price">{{number_format($trend->price)}}đ
                                            </div>
                                            @else
                                            <div class="regular-price">
                                                {{number_format($trend->price)}}đ
                                            </div>
                                            @endif
                                        </div>
                                        <div class="button-wrapper">
                                            <div class="button-group text-center">
                                                <a href='{{route("home.showProductDetail", $trend->id)}}'
                                                    class="btn btn-primary btn-cart"><i
                                                        ...
                                                        to cart</span></a>
                                                @if(auth()->check())
                                                <a href='{{route("home.favorite", $trend->id)}}'
                                                    class="btn btn-primary btn-wishlist {{($trend->favorited == true) ? 'wishlist-active' : ''}}"><i
                                                        class="material-icons">favorite</i><span>wishlist</span></a>
                                                @endif
                                                <a href="{{route("home.showProductDetail", $trend->id)}}"
                                                    class="btn btn-primary btn-quickview"><i
