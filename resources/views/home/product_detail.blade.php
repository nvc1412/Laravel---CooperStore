    ...
    <div class="container">
        <div class="row">
            ...
            <div class="product-accessories-content products grid owl-carousel">
                ...
                @foreach($recommends_pros as $recommend)
                <div class="product-layouts">
                    <div class="product-thumb">
                        <div class="image zoom">
                            <a href="{{route("home.showProductDetail", $recommend->id)}}">
                                <img src="img/products/{{$recommend->image}}" alt="02" height="501" width="385" />

                                <img src="img/products/{{$recommend->image}}" alt="03"
                                    class="second_image img-responsive" height="501" width="385" /></a>
                        </div>
                        <div class="thumb-description">
                            <div class="caption">
                                <h4 class="product-title text-capitalize"><a
                                        href="{{route("home.showProductDetail", $recommend->id)}}">{{$recommend->name}}</a>
                                </h4>
                            </div>
                            <div class="rating">
                                <div class="product-ratings d-inline-block align-middle">
                                    @for($x = 1; $x <= 5 ; $x++) @if($x <=average_rate($recommend->ratings)) <span
                                            class="fa fa-stack"><i class="material-icons">star</i></span>
                                        @else
                                        <span class="fa fa-stack"><i class="material-icons off">star</i></span>
                                        @endif
                            ...
                            <div class="price">
                                @if($recommend->discount > 0)
                                <div class="regular-price">
                                    {{number_format($recommend->discount)}}đ
                                </div>
                                <div class="old-price">{{number_format($recommend->price)}}đ</div>
                                @else
                                <div class="regular-price">
                                    {{number_format($recommend->price)}}đ
                                </div>
                                @endif
                            </div>
                                ...
                                <div class="button-group text-center">
                                    <a href='{{route("home.showProductDetail", $recommend->id)}}'
                                        class="btn btn-primary btn-cart"><i
                                            ...
                                            to cart</span></a>
                                    @if(auth()->check())
                                    <a href='{{route("home.favorite", $recommend->id)}}'
                                        class="btn btn-primary btn-wishlist {{($recommend->favorited == true) ? 'wishlist-active' : ''}}"><i
