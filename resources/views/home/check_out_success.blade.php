        ...
        <div class="row">
            <div id="order-confirmation" class="card float-left w-100 mb-10">
                <div class="card-block p-20">
                    ...
                    <p>Kiểm tra email của bạn để xem lại chi tiết đơn hàng.</p>
                </div>
            </div>
...
switch ($bill->payment) {
    ...
    default:
        echo "";
                            ...
                            <strong>Cảm ơn bạn đã sử dụng dịch vụ của chúng tôi! Đơn hàng sẽ được chuẩn bị và vận chuyển
                                trong vòng từ 3-5 ngày.</strong>
                        </div>
                    </div>
                </div>
            </div>
